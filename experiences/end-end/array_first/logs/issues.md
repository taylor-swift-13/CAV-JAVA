...
- Localization: `output/verify_20260422_041209_array_first/logs/workspace_fingerprint.json`.
...
- Localization: `annotated/verify_20260422_041209_array_first.c`.
...
QualifiedCProgramming/linux-binary/symexec \
  --input-file=annotated/verify_20260422_041209_array_first.c \
  --goal-file=output/verify_20260422_041209_array_first/coq/generated/array_first_goal.v \
  --proof-auto-file=output/verify_20260422_041209_array_first/coq/generated/array_first_proof_auto.v \
  --proof-manual-file=output/verify_20260422_041209_array_first/coq/generated/array_first_proof_manual.v \
...
- Localization: `output/verify_20260422_041209_array_first/coq/generated/array_first_proof_manual.v`.
...
- Localization: `logs/compile.log` and `output/verify_20260422_041209_array_first/coq/generated/`.
- Fix action: compiled from `QualifiedCProgramming/SeparationLogic` with the documented base load path, `-Q "$ORIG" ""`, and `-R "$GEN" SimpleC.EE.CAV.verify_20260422_041209_array_first`; then deleted all non-`.v` files under the workspace `coq/` tree.
